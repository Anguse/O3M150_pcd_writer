/*needspatch@xmldoc*/ /* This file provides the definition of the struct Meas_Customer_Data_Type in the interface version DIK1_1.5.
   
   It also provides endianess-aware functions to safely convert a binary buffer to an 
   instance of this struct (if possible).
*/

#ifndef IFM_O3M_MEAS_CUSTOMER_DATA_TYPE_DIK1_1_5_CONVERTER_H_INCLUDED
#define IFM_O3M_MEAS_CUSTOMER_DATA_TYPE_DIK1_1_5_CONVERTER_H_INCLUDED
...
typedef struct
{
    ...
    struct
    {
        ...
        /*@xmldoc(KpCustomerParameter.ROICanOutputOnOff)*/
        ifm_o3m_uint8_t ROICanOutputOnOff;
...
} ifm_o3m_Meas_Customer_Data_Type_DIK1_1_5;
